...
proc createListBoxFrame1(): Frame =
  let
    ...
    expanderListBox1 = newListBox()
    expanderListBox2 = newListBox()
    ...
    expanderRow2 = createExpandRow()


  frame1.child = mainListBox

  with expanderListBox1:
  ...
  expanderRow1.add(expanderListBox1)
  expanderRow2.add(expanderListBox2)
